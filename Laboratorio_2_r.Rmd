...
● airports: Ofrece información sobre los aeropuertos, es decir: el nombre y la
  ubicación.
● planes: Contiene información sobre aviones particulares utilizados en vuelos.
● airlines: Brinda información sobre aerolíneas.
● weather: Nos da las condiciones climáticas en la ciudad/aeropuerto de salida en
  Nueva York.
  
El esquema de las tablas se presenta en la imagen del documento pdf.
...
airlines %>%
  ...
  select(-origin, -dest) %>%
  mutate(tota_delay = arr_delay + dep_delay)
```
